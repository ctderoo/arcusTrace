...
ngrats = asarray([array([xgrats[i],ygrats[i],zgrats[i]])/linalg.norm(array([xgrats[i],ygrats[i],zgrats[i]])) for i in range(len(xgrats))])
tgrats = asarray([array([1,0,0]) for i in range(len(xgrats))])
pgrats = asarray([cross(tgrats[i],ngrats[i]) for i in range(len(xgrats))])
